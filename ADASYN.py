...
# Après ADASYN
sns.countplot(x="Class", data=data_adasyn, ax=axes[1],
              hue="Class", palette={"Normal": "steelblue", "Fraude": "crimson"}, legend=True)
axes[1].set_title("Après ADASYN")
